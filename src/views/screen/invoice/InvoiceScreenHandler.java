...
public class InvoiceScreenHandler extends BaseScreenHandler {
	...
	//data coupling
	public InvoiceScreenHandler(Stage stage, String screenPath, Invoice invoice) throws IOException, SQLException {
	...
	private void setInvoiceInfo() throws SQLException {
		...
		shippingFees.setText(Utils.getCurrencyFormat((int)invoice.getOrder().getShippingFees()));
